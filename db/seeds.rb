...
growth_hacking = Product.create(title: "Growth Hacking", 
	...
	price: "4.99", sku: "GROHACK1", download_url:"https://s3.amazonaws.com/om-stripe-payments/4kIuZMF.jpg",details: "You'll get one video",  description: %{<p>In this talk, Mattan Griffel introduces you to the concept of Growth Hacking and shares his favorite tips for getting started as a growth hacker.</p>
...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", 
    ...
    price: "4.99", sku: "GROHACK2", download_url:"https://s3.amazonaws.com/om-stripe-payments/4kIuZMF.jpg",details: "We'll charge you monthly for unlimited access to our mentoring team",  description: %{<p>In this series, Mattan Griffel introduces you to the concept of Growth Hacking and shares his favorite tips for getting started as a growth hacker.</p>
         <p><strong>What You'll Learn</strong></p>
         <ul class="no-indent">
             <li>What is a growth hacker?</li>
             <li>The 5 stages of the user lifecycle</li>
